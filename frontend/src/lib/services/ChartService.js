...
class ChartService {
  ...
  getThemeTokens() {
    ...
    return {
      grid: read('--chart-grid-color', fallback.grid),
      gridStrong: read('--chart-grid-strong', fallback.gridStrong),
      axis: read('--chart-axis-color', fallback.axis),
      label: read('--chart-label-color', fallback.label),
      title: read('--chart-title-color', fallback.title),
      legend: read('--chart-legend-color', fallback.legend),
      tooltipBg: read('--chart-tooltip-bg', fallback.tooltipBg),
      tooltipBorder: read('--chart-tooltip-border', fallback.tooltipBorder),
      tooltipTitle: read('--chart-tooltip-title', fallback.tooltipTitle),
      tooltipBody: read('--chart-tooltip-body', fallback.tooltipBody)
    };
  }
